    ...
    data() {
        return {
            ...
            menuDataList:[
                ...
                { no: 2, category: 20, name: '상품 정보 관리', icon: 'mdi-gift-outline', path:"/admin/productManage" },
                { no: 3, category: 20, name: '주문 정보 관리', icon: 'mdi-order-bool-descending-variant', path:"/admin/orderManage" },
                { no: 4, category: 20, name: '고객 후기 관리', icon: 'mdi-account-cash', path:"/admin/reviewManage" },
                { no: 5, category: 30, name: '매거진 관리', icon: 'mdi-clipboard-outline', path: "/admin/MagazineManage" },
                { no: 7, category: 30, name: '공지사항 관리', icon: 'mdi-bulletin-board', path: "/admin/BoardManage" },
                { no: 8, category: 30, name: '자가진단 관리', icon: 'mdi-file-certificate-outline', path: "/admin/SelfInquiry" },
                { no: 9, category: 30, name: '건강설문 해석 관리', icon: 'mdi-home-analytics', path: "/admin/ExplanationManage" },
                { no: 10, category: 30, name: '배너 관리', icon: 'mdi-application-settings-outline', path: "/admin/banner" },
                { no: 11, category: 40, name: '이용약관 관리', icon: 'mdi-book-information-variant', path: "/admin/policy" },
                { no: 12, category: 40, name: '개인정보 처리방침 관리', icon: 'mdi-book-information-variant', path: "/admin/personalPolicy" },
                { no: 13, category: 40, name: '자주묻는 질문 관리', icon: 'mdi-frequently-asked-questions', path: "/admin/qna" },
                { no: 14, category: 40, name: '1:1문의 관리', icon: 'mdi-human-greeting-proximity', path: "/admin/inquiry" },
                { no: 15, category: 50, name: '회원통계', icon: 'mdi-chart-line', path: "/admin/UserStatistics" },
                { no: 16, category: 50, name: '판매통계', icon: 'mdi-chart-bell-curve', path: "/admin/SaleStatistics" },
            ],
