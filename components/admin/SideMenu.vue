    ...
    data() {
        return {
            ...
            menuDataList:[
                ...
                { no: 3, category: 20, name: '주문 정보 관리', icon: 'mdi-account-cash', path:"/admin/product" },
                { no: 4, category: 20, name: '고객 후기 관리', icon: 'mdi-account-cash', path:"/admin/product" },
                ...
                { no: 10, category: 40, name: '이용약관 관리', icon: 'mdi-alpha-c-circle-outline', path: "/admin/curations" },
                { no: 11, category: 40, name: '개인정보 처리방침 관리', icon: 'mdi-alpha-c-circle-outline', path: "/admin/curations" },
